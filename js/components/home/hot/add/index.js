...
class HotAdd extends React.Component {
    ...
    add() {
        ...
        let body = 'title=' + this.state.title + '&content=' + this.state.content + '&articleType=5' + '&schoolId=1' + this.state.user.schoolId + '&userID=' + this.state.user.id;
        fetch(GLOBAL.BASE_URL + '/article/insert', {
            method: 'POST',
            headers: {
...
export default HotAdd = connect(mapStateToProps)(HotAdd);;